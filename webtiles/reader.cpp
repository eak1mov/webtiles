...
public:
    ...
    FileData readMetadata() const final;
    std::string extendedHeader() const final { return extendedHeader_; }

    FileData readTileData(TileId tileId) const final;
...
FileData ReaderImpl::readMetadata() const
{
...
FileData ReaderImpl::readTileData(TileId tileId) const
{
